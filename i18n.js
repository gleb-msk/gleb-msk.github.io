...
(function () {
  const translations = {
    ru: {
      ...
      heroSubtitle: 'Production и stage: контейнеры, CI/CD, мониторинг. Опыт с миграциями БД, health-checks, откатом по тегам.',
      heroQuickFocus: 'Фокус',
      heroQuickFocusVal: 'CI/CD, контейнеры, мониторинг и инциденты',
      heroQuickCity: 'Город',
      ...
      heroTagline: 'DevOps-инженер: 2+ года в production, несколько проектов параллельно.',
      ...
      heroStrengths2: 'Health‑checks, миграции БД в пайплайне, откат по тегам за минуты.',
      heroStrengths3: 'Надёжный edge: DNS, TLS, reverse‑proxy — сервис доступен и защищён.',
      sectionAboutTitle: 'Обо мне',
      sectionAboutLead: 'DevOps-инженер с опытом в production: контейнеры, CI/CD, мониторинг, разбор инцидентов. Работал с Docker/Compose, GitLab CI, Nginx, AWS (ECS, RDS, CloudWatch).',
      ...
      expCard2Title: 'CI/CD',
      expCard2Text: 'Перевёл ручные выкладки в GitLab CI/CD: сборка → образы → деплой по SSH с безопасным reload Nginx. Миграции БД и health‑checks в пайплайне, откат по тегам.',
      ...
      metaDesc: 'DevOps: 2+ года в production, CI/CD, Docker, AWS, мониторинг. Junior/Middle. Резюме (PDF), контакты.'
    },
    en: {
      ...
      heroQuickFocusVal: 'CI/CD, containers, monitoring and incidents',
      heroQuickCity: 'City',
      ...
      heroTagline: 'DevOps engineer: 2+ years in production, multiple projects in parallel.',
      ...
      heroStrengths2: 'Health‑checks, DB migrations in pipeline, tag-based rollback in minutes.',
      heroStrengths3: 'Reliable edge: DNS, TLS, reverse‑proxy — secure and available.',
      sectionAboutTitle: 'About me',
      sectionAboutLead: 'DevOps engineer with production experience: containers, CI/CD, monitoring, incident response. Worked with Docker/Compose, GitLab CI, Nginx, AWS (ECS, RDS, CloudWatch).',
      ...
      expCard2Title: 'CI/CD',
      expCard2Text: 'Moved manual deploys to GitLab CI/CD: build → images → deploy via SSH with safe Nginx reload. DB migrations and health‑checks in pipeline, tag-based rollback.',
      ...
      metaDesc: 'DevOps: 2+ years in production, CI/CD, Docker, AWS, monitoring. Junior/Middle. CV (PDF), contact.'
    }
  };
