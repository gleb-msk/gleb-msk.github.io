...
(function () {
  const translations = {
    ru: {
      ...
      project1Text: 'Поддержка и развитие инфраструктуры веб-платформы: Docker Compose (frontend/backend/Postgres/Redis), Nginx + TLS, GitLab CI/CD с деплоем по тегам. Встроил миграции БД в релиз, откат и восстановление из дампа. Поднял preview-окружения для веток feat/* — команда проверяет фичи до мержа без риска для prod.',
